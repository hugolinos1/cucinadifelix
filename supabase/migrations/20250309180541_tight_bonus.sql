/*
  ...
  2. Security
    - Add RLS policies for admin access to logs
...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Admins can insert booking logs" ON booking_logs;
  DROP POLICY IF EXISTS "Admins can update booking logs" ON booking_logs;
END $$;

-- Create comprehensive policies for booking_logs
